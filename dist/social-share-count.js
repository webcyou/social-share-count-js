...
},{"./is-function":6,"./is-object":7,"./request-base":8,"./response-base":9,"./should-retry":10,"component-emitter":12}],6:[function(require,module,exports){
/**
...
},{"./is-object":7}],7:[function(require,module,exports){
/**
...
var social_controller_1 = require("./social_controller");
'use strict';
var e = eval, global = e('this');
/**
 * namespace SocialCounterJS
 **/
var SocialShareCountJS;
(function (SocialShareCountJS) {
    ...
    var SocialCounter = (function () {
        function SocialCounter(option) {
            if (SocialCounter._instance) {
                return SocialCounter._instance;
            }
            else {
                this.controller = new social_controller_1.default(option);
                SocialCounter._instance = this;
            }
        }
        SocialCounter.prototype.setOption = function (option) {
            this.controller.setOption(option);
        };
        return SocialCounter;
    }());
    SocialCounter._instance = null;
    SocialShareCountJS.SocialCounter = SocialCounter;
...
},{"./social_controller":23}],14:[function(require,module,exports){
"use strict";
...
},{"./Social":21}],15:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var Model;
(function (Model) {
    var Feedly = (function (_super) {
        __extends(Feedly, _super);
        function Feedly() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
...
},{"./Social":21}],16:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
(function (Model) {
    var Google = (function (_super) {
        ...
        Google.fromData = function (data, key) {
            var google = Social_1.default.fromData(data);
            google.name = 'google';
            if (key) {
...
exports.default = Model.Google;

},{"./Social":21}],17:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
},{"./Social":21}],18:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
},{"./Social":21}],19:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
(function (Model) {
    ...
    Model.Pinterest = Pinterest;
})(Model || (Model = {}));
exports.default = Model.Pinterest;

},{"./Social":21}],20:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
},{"./Social":21}],21:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/**
 * Social Model Class
...
(function (Model) {
     ...
     **/
    var Social = (function () {
        function Social(indexNumber, name, url, count, node) {
...
(function (Model) {
    var Twitter = (function (_super) {
        ...
        Twitter.fromData = function (data) {
            var twitter = Social_1.default.fromData(data);
...
},{"./Social":21}],23:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var social_model_1 = require("./social_model");
var social_view_1 = require("./social_view");
var social_service_1 = require("./social_service");
var _ = {
...
(function (SocialShareCountJS) {
    ...
    var Controller = (function () {
        function Controller(option) {
            var _this = this;
            this.model = new social_model_1.default();
            this.socialCounters = [];
            if (option) {
                this.model.setOption(option);
            }
            this.view = new social_view_1.default(function (socialCounters) {
                socialCounters.forEach(function (socialCounter) {
                    _this.socialCounters.push(_this.model.createSocialCounter(socialCounter));
                });
                _this.requestCountData(_this.socialCounters);
            });
        }
        Controller.prototype.setOption = function (option) {
            this.model.setOption(option);
        };
        Controller.prototype.requestCountData = function (socialCounters) {
            var _this = this;
            socialCounters.forEach(function (socialCounter) {
                new social_service_1.default().sendData(socialCounter)
                    .then(function (responseData) {
                    _this.setSocialCount(socialCounter.indexNumber, responseData);
                    _this.view.setSocialCount(_this.socialCounters);
                }).catch(function (err) {
                    console.error(err);
                });
            });
        ...
        Controller.prototype.setSocialCount = function (indexNumber, responseData) {
            _.find(this.socialCounters, function (social) {
    ...
    SocialShareCountJS.Controller = Controller;
})(SocialShareCountJS || (SocialShareCountJS = {}));
exports.default = SocialShareCountJS.Controller;

},{"./social_model":24,"./social_service":25,"./social_view":26,"lodash.find":2}],24:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Facebook_1 = require("./model/Facebook");
var Twitter_1 = require("./model/Twitter");
var Google_1 = require("./model/Google");
...
var SocialShareCountJS;
(function (SocialShareCountJS) {
    var SocialCounterModel = (function () {
        function SocialCounterModel() {
        }
        SocialCounterModel.prototype.createSocialCounter = function (social) {
            var socialModel;
            switch (social.name) {
                case 'facebook':
                    socialModel = Facebook_1.default.fromData(social);
                    break;
                case 'twitter':
                    socialModel = Twitter_1.default.fromData(social);
                    break;
                case 'google':
                    if (this.option && this.option.google_key) {
                        socialModel = Google_1.default.fromData(social, this.option.google_key);
                    }
                    else {
                        socialModel = Google_1.default.fromData(social);
                    }
                    break;
                case 'feedly':
                    socialModel = Feedly_1.default.fromData(social);
                    break;
                case 'pinterest':
                ...
                case 'hatena':
                    ...
                    break;
                case 'pocket':
                    socialModel = Pocket_1.default.fromData(social);
                    break;
            }
            return socialModel;
        };
        SocialCounterModel.prototype.setOption = function (option) {
            this.option = option;
        };
        return SocialCounterModel;
    }());
    SocialShareCountJS.SocialCounterModel = SocialCounterModel;
})(SocialShareCountJS || (SocialShareCountJS = {}));
exports.default = SocialShareCountJS.SocialCounterModel;

},{"./model/Facebook":14,"./model/Feedly":15,"./model/Google":16,"./model/Hatena":17,"./model/Linkedin":18,"./model/Pinterest":19,"./model/Pocket":20,"./model/Twitter":22}],25:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/// <reference path='./_all.ts' />
...
var SocialService = (function () {
    ...
    SocialService.prototype.sendData = function (social) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            if (social.name == "google" && _this.isGoogleKey(social.sendData)) {
                request
                    .post(social.url)
...
},{"es6-promise":1,"superagent":5,"superagent-jsonp":4}],26:[function(require,module,exports){
/// <reference path='./_all.ts' />
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/**
...
(function (SocialShareCountJS) {
     ...
     * @constructor
     **/
    var SocialCounterView = (function () {
        /**
         * SocialShareCount View Class
         * @param {requestCallback} callBack - The callback that handles the response.
         **/
        function SocialCounterView(callBack) {
            var _this = this;
            this.socialCounterElements = [];
            document.addEventListener("DOMContentLoaded", function () {
                _this.bindSocialCounterElements();
                callBack(_this.socialCounterElements);
            });
        }
        SocialCounterView.prototype.bindSocialCounterElements = function () {
            var _this = this;
            var socialViewList = [];
            socialCountSelectors.forEach(function (socialCountSelector) {
                socialViewList.push(_this.createSocialCounterElements(socialCountSelector, document.querySelectorAll(socialCountSelector)));
            });
            socialViewList.forEach(function (socialView) {
                socialView.forEach(function (social) {
                    _this.socialCounterElements.push(social);
                });
            });
        };
        SocialCounterView.prototype.createSocialCounterElements = function (selector, elements) {
            var _this = this;
            var socialViewList = [];
            switch (selector) {
                case '[data-sc-fb]':
                    elements.forEach(function (element) {
                        socialViewList.push(_this.createSocialView('facebook', element, element.dataset.scFb));
                    });
                    break;
                case '[data-sc-tw]':
                    elements.forEach(function (element) {
                        socialViewList.push(_this.createSocialView('twitter', element, element.dataset.scTw));
                    });
                    break;
                case '[data-sc-gp]':
                    elements.forEach(function (element) {
                        socialViewList.push(_this.createSocialView('google', element, element.dataset.scGp));
                    });
                    break;
                case '[data-sc-fd]':
                    elements.forEach(function (element) {
                        socialViewList.push(_this.createSocialView('feedly', element, element.dataset.scFd));
                    });
                    break;
                case '[data-sc-pr]':
                    elements.forEach(function (element) {
                ...
                case '[data-sc-hb]':
                    elements.forEach(function (element) {
                        socialViewList.push(_this.createSocialView('hatena', element, element.dataset.scHb));
                    });
                    break;
                case '[data-sc-pk]':
                    elements.forEach(function (element) {
                        socialViewList.push(_this.createSocialView('pocket', element, element.dataset.scPk));
                    });
                    break;
            }
            return socialViewList;
        };
        SocialCounterView.prototype.createSocialView = function (name, element, url) {
        ...
        SocialCounterView.prototype.setSocialCount = function (socialCounters) {
            socialCounters.forEach(function (social) {
                social.node.innerText = social.count;
            });
        };
        return SocialCounterView;
    }());
    SocialShareCountJS.SocialCounterView = SocialCounterView;
    /**
     * Social View Class
     * Creates a new Social
     * @constructor
     **/
    var Social = (function () {
        function Social(name, element, url) {
            this.name = name;
            this.element = element;
            this.url = url;
        }
        Social.fromData = function (data) {
            return new Social(data.name, data.element ? data.element : null, data.url);
        };
        return Social;
    }());
})(SocialShareCountJS || (SocialShareCountJS = {}));
exports.default = SocialShareCountJS.SocialCounterView;
